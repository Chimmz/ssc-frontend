...
import HanseekArticleFirstImg from '../img/hanseek-article-first-img.webp';
import HanseekArticlePieChart from '../img/hanseek-article-pie-chart.webp';
import HanseekArticleDoubleImg1 from '../img/hanseek-article-double-img-1.webp';
import HanseekArticlePhonesImg from '../img/hanseek-article-phones-img.webp';
// import hanseek-article-double-img from './img/hanseek-article-double-img-1.webp'
import HanseekArticleDoubleImg2 from '../img/hanseek-article-double-img-2.webp';
import HanseekArticleDoubleImg3 from '../img/hanseek-article-double-img-3.webp';
import HanseekArticleStep3 from '../img/hanseek-article-step3.webp';
import HanseekArticleBonusImg from '../img/hanseek-article-bonus-img.webp';
import HanseekArticleDoubleImg4 from '../img/hanseek-article-double-img-4.webp';
    ...
    <section className={cls(fonts.raleway, 'section-pad-top section-pad-bottom-lg')}>
      <div className="container app-container d-flex flex-column">
        ...
        <figure className="mb-7">
          <img
            src={HanseekArticleFirstImg.src}
            style={{ height: 'max(33vw, 22rem)' }}
            className="w-100 rounded-3 object-fit-cover"
            alt=""
          />
          <figcaption className={cls(fonts.lato, 'fs-5 color-pry-dark fw-bold mt-2')}>
        ...
        <div className={styles.newsSectionContent}>
          ...
          <img src={HanseekArticlePieChart.src} className="w-100" alt=" rounded-3" />
          <p>
        ...
        <div className={styles.newsSectionContent}>
          ...
          <p className="my-6">
            After we found Hanseekers who wanted to join our first ever event, we got to work
            in order to tailor the best experience for them.
          </p>

          <div className={styles.step}>
            <figure>
              <img
                src={HanseekArticleDoubleImg1.src}
                alt=""
            ...
            <article>
              ...
              <p>
                ...
                and preferences. This includes the level of understanding in Korean food, how
                well one can handle spiciness and more that helps us understand each
          ...
          <div className={cls(styles.step, styles.rStep)}>
            <figure>
              <img
                src="/img/hanseek-article-phones-img.webp"
                alt=""
                className="object-fit-cover rounded-3"
              />
            </figure>
            <article>
              ...
              <p>
                Based on our survey, we choose menus that each person would enjoy. We consider
                individuals&apos; preference and the overall group&apos;s responses. We also
                want the overall combination of the menu to be well balanced. Based on the
                survey, this is how we created the set of orders:
              </p>
            </article>
          </div>
          <p className="my-6">
          ...
          <figure className="mb-5">
            <img
              src="/img/hanseek-article-double-img-1.webp"
              className="w-100 object-fit-cover rounded-3"
              height={500}
              alt=""
            />
            <figcaption className={cls(fonts.lato, 'mt-2 fs-5')}>
          ...
          <ul className="d-flex flex-column gap-3 mb-5">
            <li>
              For the main dish, we referred to what types of protein our participants liked.
              In the group, there was no vegetarian, so it was okay to have meat or seafood.
            </li>
            <li>
            ...
            <li>
              ...
              was perfect because it was not only noodles, but added a spicy component to the
              first round.
            </li>
          </ul>
          ...
          <figure className="mb-5">
            <img
              src={HanseekArticleDoubleImg2.src}
              height={500}
              className="w-100 object-fit-cover rounded-3"
              alt=""
            />
            <figcaption className={cls(fonts.lato, 'mt-2')}>
          ...
          <ul className="d-flex flex-column gap-3 mb-5">
            ...
            <li>
              Braised kimchi and pork was a perfect menu as a rice dish with a good balance of
              meat and kimchi.
            </li>
            <li>
            ...
            <li>
              In addition, the two menu matched the favorite food of our participants — as all
              of our participants liked {`‘`}food with broth&apos; and some of their favorite
              menu was ‘spicy bone broth soup (뼈해장국)&apos; and ‘kimchi stew
              (김치찌개)&apos;.
            </li>
          </ul>
          ...
          <figure className="mb-5">
            <img
              src={HanseekArticleDoubleImg3.src}
              height={500}
              className="w-100 object-fit-cover rounded-3"
              alt=""
            />
          ...
          <p className="mb-6">
            What made this event more wholesome is that the venue is run by Mr. Hong who is a
            famous makgeolli sommelier. Makgeolli here is freshly brewed in the store offering
            rich flavored makgeolli, 100% made with natural ingredients.
          </p>

          <figure>
            <img
              src={HanseekArticleBonusImg.src}
              alt=""
              className="w-100 object-fit-cover rounded-3"
            />
            <figcaption className={cls(fonts.lato, 'mt-2 fs-5')}>
          ...
          <p className="my-6">
            Mr. Hong was kind enough to explain behind story of makgeolli, show us the brewing
            factory and offer us some special makgeolli. Hanseekers definitely enjoyed every
            cups of the makgeolli.
          </p>

          <figure>
            <img
              src={HanseekArticleDoubleImg4.src}
              height={500}
              className="w-100 object-fit-cover rounded-3"
              alt=""
            />
        ...
        <div className={styles.newsSectionContent}>
          ...
          >
            <li>
              Nice organization, really good food and comfortable conversation. I was able to
              meet new people and try new food even tho I stayed in Korea for quite long. Also
              learned more about makgroli
            </li>
            <li>
          ...
          <p>
            ...
            us to continue bringing the best service for our audience and we will continue to
            research in what ways we can bring positive experience for everyone.
          </p>
        </div>
        ...
        <div className={styles.newsSectionContent}>
          ...
          <div className="tags d-flex align-items-center flex-wrap gap-3">
            <div className="bg-light flex-center w-max-content p-2 px-3 rounded">
              Korean Food
            </div>
            <div className="bg-light flex-center w-max-content p-2 px-3 rounded">
              South Korea Travel
            </div>
            <div className="bg-light flex-center w-max-content p-2 px-3 rounded">Startup</div>
          </div>
        </div>
      </div>
    </section>
