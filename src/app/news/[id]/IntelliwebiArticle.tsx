...
import JoshuaImg from '../img/joshua.webp';
        ...
        <div className={styles.newsSectionContent}>
          <ol className="d-flex flex-column gap-5">
            <li>
              ...
              <p>
                I was attending online pitch practice workshop since last year. And I saw many
                people are interested in practicing their pitch and getting some education in
                terms of investor pitch.
              </p>
            </li>
            <li>
              <h6 className="fw-bold fs-3">What did you before this business?</h6>
              <p>
                I was an instructor at a flight school in Texas. And I had training to become
                a commercial pilot. But I found K-startup by coincidence and I wanted a
                challenge in my life before I go to the airline. So I came back to Korea, got
                a data analyst job since I was interested in data analysis. A year later, I
                quit with two of my coworkers and we started Intelliwebi.
              </p>
            </li>
            <li>
              ...
              <p>
                I would say it grounds up everything related to your business pitch. Users can
                generate their pitch deck, upload their virtual pitch and see the analyzed
                result, practice pitching to virtual chatbot with an investor/customer
                persona.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                ...
                advanced human-like chatbot with many different personalities. People will be
                able to choose the personality they want to practice their pitch.
              </p>
            </li>
            <li>
              <h6 className="fw-bold fs-3">
