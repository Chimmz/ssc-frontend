...
import FounderImg from '../img/innovobloc-founder-img.jpg';
      ...
      <div className="container app-container d-flex flex-column">
        ...
        <div className={cls(styles.newsSectionContent, '')}>
          <h3
            className={cls(
              ...
              styles.leftBorder,
              'fs-1 color-pry-dark fw-bold mb-7'
            )}
          >
        ...
        <div className={styles.newsSectionContent}>
          <p>
            ...
            achievement marks a significant leap towards transforming the healthcare industry
            and enhancing patient care through cutting-edge digital solutions.
          </p>
          <br />
          <p>
            The patent underscores InnovoBloc&#39;s commitment to revolutionizing traditional
            healthcare practices by leveraging technology. This innovative e-prescription
            solution promises to streamline and modernize the prescription process, making it
            more efficient, secure, and accessible for healthcare providers and patients
            alike.
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            The E-prescription delivery system&apos;s technology developed by InnovoBloc is a
            result of rigorous research, development, and collaboration with experts in the
            healthcare and technology sectors. By digitizing the prescription process, the
            system aims to eliminate the challenges associated with traditional paper-based
            prescriptions, including handwriting &amp; processing errors, lost documents, and
            inefficient communication between healthcare providers and pharmacies.
          </p>
          <br />
          <p>
            With its utility patent in hand, InnovoBloc is well-positioned to advance its
            mission of leveraging technology to make a positive impact on various industries.
            The company&#39;s visionary approach extends beyond e-prescriptions; it has also
            been working on the development of Tabularium, an innovative document version
            management platform that has already garnered traction for its potential to
            reshape how businesses handle documents.
          </p>
          <br />
          <p>
            As InnovoBloc continues to make strides in innovation, the company seeks
            partnerships and collaborations that share its vision of leveraging technology to
            drive positive change. With the e-prescription patent paving the way for
            healthcare transformation, InnovoBloc is poised to leave an indelible mark on the
          ...
          <p>
            ...
            With a strong commitment to innovation, the company has achieved a utility patent
            for its e-prescription technology, showcasing its dedication to improving
