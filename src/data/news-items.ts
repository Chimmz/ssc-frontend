import FounderImg from '../app/news/img/innovobloc-founder-img.jpg';
import HanseekArticleFirstImg from '../app/news/img/hanseek-article-first-img.webp';
import FlairAndProductsImg from '../app/news/img/flair-and-products.png';
...
export const NEWS_ITEMS: NewsObj[] = [
  {
    ...
    imgUrl: HanseekArticleFirstImg.src,
    updatedAt: ''
  },
  {
    _id: 'innovobloc',
  ...
  },
  {
    ...
    createdAt: new Date(1691449200000).toString(),
    imgUrl: FlairAndProductsImg.src,
    updatedAt: ''
  },
  {
    _id: 'intelliwebi',
    ...
    createdAt: new Date(1691449200000).toString(),
    imgUrl: '/img/intelliwebi-logo-no-text.jpg',
    updatedAt: ''
  }
];
